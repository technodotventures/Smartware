...
| Substrate | explicit legal-hold marker | **DECIDED (ADR-0008, 2026-09-14): not built — v1 composition stands** (hold lane + snapshot + attestation); marker is trigger-gated | @user / tech-head | G4 — only if an ADR-0008 §3 trigger fires |
