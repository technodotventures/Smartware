...
- No dates until Coffee's window is known. Open @user decisions: (1) release window, (2) which flows ship in the launch cut, (3) whether G3.1 export tool ships substrate-side now (recommended), (4) legal-hold marker vs v1 composition — **decided 2026-09-14: v1 composition (ADR-0008); no substrate marker, trigger-gated**.
